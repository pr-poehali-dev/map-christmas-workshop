...
const PLACES: Place[] = [
  ...
  },
  {
    ...
    description:
      "Слева от общего здания с «Рождественским Яблоком» и «Старым Чемоданом» притаилась удивительная мастерская, где создают настоящие калейдоскопы — от маленьких карманных до больших напольных.",
    color: "#4a6741",
    x: 38,
    y: 62,
  },
  {
    ...
    description:
      "Красно-белый маяк стоит напротив Мастерской Калейдоскопов, через дорогу. Его яркие полосы видны издалека — найдёшь маяк, найдёшь всё остальное!",
    color: "#c8922a",
    x: 38,
    y: 28,
  },
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="flex-1 w-full">
            ...
            >
              ...
              >
                {/* Яблоко ↔ Чемодан (одно здание) */}
                <line
                  x1="62" y1="62" x2="74" y2="62"
                  stroke="#8b3a2a" strokeWidth="1" strokeLinecap="round"
                />
                {/* Яблоко ↔ Калейдоскоп (дорога слева) */}
                <line
                  x1="62" y1="62" x2="38" y2="62"
                  stroke="#5a3a1a" strokeWidth="0.6" strokeDasharray="2,1.5" strokeLinecap="round"
                />
                {/* Калейдоскоп ↔ Маяк (напротив, через дорогу) */}
                <line
                  x1="38" y1="62" x2="38" y2="28"
                  stroke="#c8922a" strokeWidth="0.6" strokeDasharray="2,1.5" strokeLinecap="round"
                />
                {/* Яблоко ↔ Чайный Домик (напротив) */}
                <line
                  x1="62" y1="62" x2="62" y2="28"
                  stroke="#4a6741" strokeWidth="0.6" strokeDasharray="2,1.5" strokeLinecap="round"
                />
                {/* Яблоко ↔ Сыроварня */}
                <line
                  x1="62" y1="62" x2="76" y2="45"
                  stroke="#c8922a" strokeWidth="0.6" strokeDasharray="2,1.5" strokeLinecap="round"
                />
                {/* Сыроварня ↔ Чайный Домик */}
                <line
                  x1="76" y1="45" x2="62" y2="28"
                  stroke="#c8922a" strokeWidth="0.6" strokeDasharray="2,1.5" strokeLinecap="round"
                />
              </svg>
